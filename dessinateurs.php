			...
			<div id="general">
				...
				<div id="principal">
					<div class="centre">
						<h1><a href="./"><img src="images/logo.png" alt="abciss architectes" /></a></h1>
						<div id="ariane">
							<img class="vers_menu" src="images/vers-menu.png" alt="vers menu" /><a class="sel vers_menu">MENU</a><span class="ligne1"></span><a class="vers_menu">AGENCE</a><span class="ligne2"></span><a class="vers_menu">L'EQUIPE</a><span class="ligne"></span><a href="dessinateurs.php" class="sel">LES METIERS</a>
						</div>
						<div id="conteneur">
							...
							<div id="metier_droite">
								<div class="picto">
									...
									<a href="dessinateurs.php" id="dessinateur" class="sel"></a>
								...
								<div class="texte">
									<h3>DES DESSINATEURS PROJETEURS</h3>
									<p>Les dessinateurs projeteurs assurent l'exécution et la mise au net de tous travaux de dessin. Ils participent à la conception du projet en relation directe avec l’architecte.</p>
								</div>
								<div class="pied"></div>
							</div>
							<div class="pied"></div>
