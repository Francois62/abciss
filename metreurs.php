			...
			<div id="general">
				...
				<div id="principal">
					<div class="centre">
						<h1><a href="./"><img src="images/logo.png" alt="abciss architectes" /></a></h1>
						<div id="ariane">
							<img class="vers_menu" src="images/vers-menu.png" alt="vers menu" /><a class="sel vers_menu">MENU</a><span class="ligne1"></span><a class="vers_menu">AGENCE</a><span class="ligne2"></span><a class="vers_menu">L'EQUIPE</a><span class="ligne"></span><a href="metreurs.php" class="sel">LES METIERS</a>
						</div>
						<div id="conteneur">
							...
							<div id="metier_droite">
								<div class="picto">
									...
									<a href="metreurs.php" id="metreur" class="sel"></a>
								...
								<div class="texte">
									<h3>DES METREURS</h3>
									<p>Nos métreurs interviennent le plus tôt possible dans le processus de conception afin d’établir le descriptif et l’estimation  des travaux. Ils rédigent ensuite toutes les pièces du dossier de consultation des entreprises en parfaite collaboration avec l’architecte.</p>
								</div>
								<div class="pied"></div>
							</div>
							<div class="pied"></div>
