			...
			<div id="general">
				...
				<div id="principal">
					<div class="centre">
						<h1><a href="./"><img src="images/logo.png" alt="abciss architectes" /></a></h1>
						<div id="ariane">
							<img class="vers_menu" src="images/vers-menu.png" alt="vers menu" /><a class="sel vers_menu">MENU</a><span class="ligne1"></span><a class="vers_menu">AGENCE</a><span class="ligne2"></span><a class="vers_menu">L'EQUIPE</a><span class="ligne"></span><a href="environnement.php" class="sel">LES METIERS</a>
						</div>
						<div id="conteneur">
							...
							<div id="metier_droite">
								<div class="picto">
									...
									<a href="environnement.php" id="environnement" class="sel"></a>
								...
								<div class="texte">
									<h3>UN POLE ENVIRONNEMENT</h3>
									<p>Pleinement engagés dans le développement durable, nous avons en interne une sociologue – urbaniste ainsi qu’un thermicien pour  maîtriser, dès les premières esquisses, l’environnement du projet, les besoins en énergie liés à l’enveloppe du bâtiment afin de répondre aux différents labels souscrits.</p>
								</div>
								<div class="pied"></div>
							</div>
							<div class="pied"></div>
