			...
			<div id="general">
				...
				<div id="formulaire-gauche">
					<form name="creer-projet" method="post" action="php/traitement-projet.php" enctype="multipart/form-data">
						...
						<div class="colonne">		
							<p><label for="lieu" class="titre-form">Lieu</label><br/><input type="text" class="court" id="lieu" name="lieu"/></p>						
							<p><label for="status" class="titre-form">Statut</label><br/><input type="text" class="court" id="status" name="status"/></p>
							<div class="pied"></div>
						</div>
						<div class="pied"></div>
						<div class="colonne">
							<p><label for="surface" class="titre-form">Surface</label><br/><input type="text" class="court" id="surface" name="surface"/></p>			
							<p><label for="cout" class="titre-form">Coût</label><br/><input type="text" class="court" id="cout" name="cout"/></p>
							<div class="pied"></div>
						</div>
						...
						<p><label for="categorie" class="titre-form">Catégorie</label><br/><select class="court" id="categorie" name="categorie"><?php foreach($tab_categorie as $value){ ?><optgroup label="<?php echo
						$value['nom']; ?>"><?php foreach($value as $key => $nom){ if($key != 'nom'){?><option value="<?php echo $key; ?>"><?php echo $nom; ?></option><?php }} ?></optgroup><?php } ?></select></p>
						<p><span class="titre-form">Séléction</span><br/><label for="oui2">Oui</label> <input type="radio" id="oui2" name="selection" value="1"/>&nbsp;&nbsp;&nbsp;&nbsp;<label for="non2">Non</label> <input type="radio" id="non2" name="selection" value="0" checked="checked"/></p>
						...
						<p><label for="pdf" class="titre-form">Pdf</label><br/><input type="file" class="court" name="pdf" id="pdf"/></p>
