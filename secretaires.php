			...
			<div id="general">
				...
				<div id="principal">
					<div class="centre">
						<h1><a href="./"><img src="images/logo.png" alt="abciss architectes" /></a></h1>
						<div id="ariane">
							<img class="vers_menu" src="images/vers-menu.png" alt="vers menu" /><a class="sel vers_menu">MENU</a><span class="ligne1"></span><a class="vers_menu">AGENCE</a><span class="ligne2"></span><a class="vers_menu">L'EQUIPE</a><span class="ligne"></span><a href="secretaires.php" class="sel">LES METIERS</a>
						</div>
						<div id="conteneur">
							...
							<div id="metier_droite">
								<div class="picto">
									...
									<a href="secretaires.php" id="secretaire" class="sel"></a>
								...
								<div class="texte">
									<h3>DES SECRETAIRES</h3>
									<p>Nos secrétaires sont à votre écoute. Diffusion des comptes – rendus, établissement des bons de paiements afin de vous offrir une parfaite gestion financière du chantier dans les délais impartis. Les secrétaires effectuent les tâches indispensables au bon déroulement de vos projets.</p>
								</div>
								<div class="pied"></div>
							</div>
							<div class="pied"></div>
