			...
			<div id="general">
				...
				<div id="principal">
					<div class="centre">
						<h1><a href="./"><img src="images/logo.png" alt="abciss architectes" /></a></h1>
						<div id="ariane">
							<img class="vers_menu" src="images/vers-menu.png" alt="vers menu" /><a class="sel vers_menu">MENU</a><span class="ligne1"></span><a class="vers_menu">AGENCE</a><span class="ligne2"></span><a class="vers_menu">L'EQUIPE</a><span class="ligne"></span><a href="comptables.php" class="sel">LES METIERS</a>
						</div>
						<div id="conteneur">
							...
							<div id="metier_droite">
								<div class="picto">
									...
									<a href="comptables.php" id="comptable" class="sel"></a>
								</div>
								<div class="fleche"><img src="images/vers-droite.png" alt=">"/></div>
								<div class="texte">
									<h3>DES COMPTABLES</h3>
									<p>Nous apportons une importance toute particulière à la gestion de nos comptes. Une bonne gestion de notre part est un gage de sérieux et une assurance pour vous, maître d’ouvrage, de voir aboutir votre projet.</p>
								</div>
								<div class="pied"></div>
							</div>
							<div class="pied"></div>
