			...
			<div id="general">
				...
				<div id="principal">
					<div class="centre">
						<h1><a href="./"><img src="images/logo.png" alt="abciss architectes" /></a></h1>
						<div id="ariane">
							<img class="vers_menu" src="images/vers-menu.png" alt="vers menu" /><a class="sel vers_menu">MENU</a><span class="ligne1"></span><a class="vers_menu">AGENCE</a><span class="ligne2"></span><a class="vers_menu">L'EQUIPE</a><span class="ligne"></span><a href="techniciens.php" class="sel">LES METIERS</a>
						</div>
						<div id="conteneur">
							...
							<div id="metier_droite">
								<div class="picto">
									<a href="architectes.php" id="architecte" class="visu"></a>
									...
									<a href="techniciens.php" id="technicien" class="sel"></a>
									<a href="comptables.php" id="comptable" class="visu"></a>
								</div>
								<div class="fleche"><img src="images/vers-droite.png" alt=">"/></div>
								<div class="texte">
									<h3>DES TECHNICIENS DE CHANTIER</h3>
									<p>Une fois les entreprises désignées, un de nos techniciens de chantier prend en charge le suivi de l’exécution de l’ouvrage. Il anime les réunions de chantier et valide l’ensemble des situations des entreprises. Il vous assiste au moment de la réception du bâtiment et établit l’ensemble des procès verbaux nécessaires.</p>
								</div>
								<div class="pied"></div>
							</div>
							<div class="pied"></div>
